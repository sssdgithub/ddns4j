...
public class TencentCloudAPITC3Singer {
    ...
    private final static String SERVICE = "dnspod";
    public final static String HOST = "dnspod.tencentcloudapi.com";
    private final static String VERSION = "2021-03-23";
    ...
    public static TreeMap<String,String> buildSignRequestHeaderWithBody(String secretId,String secretKey,String action,String jsonBody) throws Exception {
        ...
        System.out.println("************* TencentCloud: 步骤 1：拼接规范请求串 *************");
